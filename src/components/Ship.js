  ...
  return (
    <div className="shipTO">
      <div className="country">
        ...
        <p className="ship2">Lead Time <label>{props.ship.shipping.lead_time.value}</label><img src={info} className="envelop" alt="envelope" /></p>
        <p className="ship2">Shiping time <label>{props.ship.shipping.method.shipping_time.value}</label><img src={info} className="envelop" alt="envelope" /></p>     
      </div>
